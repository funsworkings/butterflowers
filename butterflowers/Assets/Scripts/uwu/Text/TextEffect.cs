...
public abstract class TextEffect : MonoBehaviour
{
    ...
    protected virtual void ComputeTranslationPerVertex(ref Vector3 offset, int index, int length) { offset = Vector3.zero; }
    protected virtual void ComputeRotationPerVertex(ref Vector3 offset, int index, int length) { offset = Vector3.zero; }
    protected virtual void ComputeScalePerVertex(ref Vector3 offset, int index, int length) { offset = Vector3.one; }
}