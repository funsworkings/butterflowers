...
public class GesturesEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (Gestures.clip != null) 
        {
            ...
            EditorCurveBinding[] bindings = AnimationUtility.GetCurveBindings(Gestures.clip);
    ...
    */
        ...
        string id = (string.IsNullOrEmpty(name))? Extensions.RandomString(12) + ".anim" : name + ".anim";
