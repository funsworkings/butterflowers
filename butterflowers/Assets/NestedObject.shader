...
Shader "NestedObject"
{
	Properties
	{
		...
		_LocalDisplacement("LocalDisplacement", Float) = 0.005
	...
	SubShader
	{
		...
		uniform float Fill;
		uniform float _LocalDisplacement;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ase_worldPos - ( round( ( ase_worldPos * _GridUnits ) ) / _GridUnits ) ) + ( ( ( ( ( cos( mulTime47 ) + 1.0 ) / 2.0 ) * ( Fill * _LocalDisplacement ) ) + ( ( 3.0 * temp_output_52_0 * 10.0 ) * ( _Displacement * _PlayerPos.w ) ) ) * ase_vertexNormal ) );
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18800
315.3333;0.6666667;1055;759;1213.977;-415.4617;1.479985;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-605.9448,-1236.696;Inherit;False;Global;Fill;Fill;1;0;Create;True;0;0;0;False;0;False;0.51;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-385.1859,1111.054;Inherit;False;Property;_LocalDisplacement;LocalDisplacement;15;0;Create;True;0;0;0;False;0;False;0.005;0.005;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=50CB2978D386058230FB90AD6C0715EB8ABE6CED