...
Shader "NestVertexSnapping"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_5_0_g1 = ( ( ase_worldPos - appendResult43 ) / _radius );
			...
			float temp_output_54_0 = ( 3.0 * ( 1.0 - clampResult48 ) * 10.0 );
			float temp_output_55_0 = ( temp_output_54_0 * ( _Displacement * _PlayerPos.w ) );
			float mulTime72 = _Time.y * -5.0;
			float temp_output_69_0 = ( _Float0 + ( temp_output_55_0 * cos( mulTime72 ) ) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_54_0 = ( 3.0 * ( 1.0 - clampResult48 ) * 10.0 );
			float temp_output_55_0 = ( temp_output_54_0 * ( _Displacement * _PlayerPos.w ) );
			float4 temp_output_78_0 = ( tex2D( _Texture1, uv_Texture1 ) * temp_output_55_0 );
...
/*ASEBEGIN
Version=18800
675;37;1117;964;1133.074;1255.923;1.470436;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-2411.244,815.2151;Inherit;False;Property;_radius;radius;1;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-1023.064,1522.05;Inherit;False;Property;_Displacement;Displacement;8;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-723.8638,1123.552;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;-379.9227,1231.193;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;69;-429.7069,177.862;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;76;-377.3409,-323.9758;Inherit;True;Property;_Texture1;Texture 1;10;0;Create;True;0;0;0;False;0;False;None;529239097d02f9f42b0ddd436c6fcbb0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-1155.395,1343.479;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;1.33;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-2343.991,1277.124;Inherit;False;Property;_radius2;radius2;3;0;Create;True;0;0;0;False;0;False;0;3.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;158.688,-215.5186;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;68;-527.9182,1085.517;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2233.134,1345.117;Inherit;False;Property;_hardness2;hardness2;7;0;Create;True;0;0;0;False;0;False;0;2.13;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=22D3834F87542C61B902F48F7CF2E4A36790B231