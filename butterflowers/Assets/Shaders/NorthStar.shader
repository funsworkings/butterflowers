...
Shader "NorthStar"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ( float4( ase_worldNormal , 0.0 ) * tex2Dlod( _VertexOffsetMask, float4( uv_TexCoord80, 0, 0.0) ) ) * _VertexOffsetStrength ) + float4( ( ( ase_vertexNormal * ( 1.0 - clampResult99 ) * -10.0 ) * ( _Displacement * _PlayerPos.w ) ) , 0.0 ) ).rgb;
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18800
675;37;1117;964;1414.309;1967.901;4.000922;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;100;-54.72077,1477.57;Inherit;False;Constant;_VertexNormalStrength;Vertex Normal Strength;5;0;Create;True;0;0;0;False;0;False;-10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;208.3567,963.1857;Inherit;False;Property;_VertexOffsetStrength;Vertex Offset Strength;7;0;Create;True;0;0;0;False;0;False;0;0.67;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;118;363.8857,-313.5277;Inherit;True;Property;_RoundedEmission;Rounded Emission;8;0;Create;True;0;0;0;False;0;False;None;a2bb1f1e41ae1cd4fac910ebe93f00ae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;90;167.2417,179.2999;Inherit;True;Property;_OpacityMask;Opacity Mask;9;0;Create;True;0;0;0;False;0;False;None;a2bb1f1e41ae1cd4fac910ebe93f00ae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;25;610.246,-796.5487;Inherit;True;Property;_MaterialTexture;Material Texture;10;0;Create;True;0;0;0;False;0;False;None;a2bb1f1e41ae1cd4fac910ebe93f00ae;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;120;644.6359,-406.1251;Inherit;True;Property;_Normal;Normal;12;0;Create;True;0;0;0;False;0;False;None;371fa5d370f67534696194100d17bfad;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;119;729.9822,63.91272;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;0;False;0;False;0;0.36;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=21104B00C74294C68D947DE9283CA57006B56E09